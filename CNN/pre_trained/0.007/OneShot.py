...
class NormalCell(nn.Module):
    def __init__(self, out_channels, training, drop_prob, save_device=torch.device('cpu')):
        ...
        # in0: closer source
        self.in0_1_0 = Sep3(out_channels, reduction=False, save_device=save_device)
        ...
        self.in1_0_0 = Sep3(out_channels, reduction=False, save_device=save_device)
        self.in1_0_1 = Ident(out_channels, reduction=False, save_device=save_device)

        self.in1_1 = MaxPool(out_channels, reduction=False, save_device=save_device)

        self.in1_2 = Sep3(out_channels, reduction=False, save_device=save_device)

        self.in1_3_0 = Sep5(out_channels, reduction=False, save_device=save_device)
        self.in1_3_1 = MaxPool(out_channels, reduction=False, save_device=save_device)
        self.in1_3_2 = AvgPool(out_channels, reduction=False, save_device=save_device)

        self.sel_0_3 = Ident(out_channels, reduction=False, save_device=save_device)

    def forward(self, x_in0, x_in1):
        x_in0_0 = F.dropout2d(self.in1_0_0(x_in1), training=self.training, p=self.drop_prob) + \
        ...
        x_3 = F.dropout2d(self.in1_3_0(x_in1), training=self.training, p=self.drop_prob) + \
              ...
              F.dropout2d(self.in1_3_2(x_in1), training=self.training, p=self.drop_prob) + \
...
class ReductCell(nn.Module):
    def __init__(self, out_channels, drop_prob, training, save_device=torch.device('cpu')):
        ...
        self.drop_prob = drop_prob
        # in0: closer source
        self.in0_0_0 = Sep5(out_channels, reduction=True, save_device=save_device)
        self.in0_0_1 = AvgPool(out_channels, reduction=True, save_device=save_device)
        ...
        self.in1_0_2 = Ident(out_channels, reduction=True, save_device=save_device)
        self.in1_0_3 = Sep5(out_channels, reduction=True, save_device=save_device)

        self.in1_1 = AvgPool(out_channels, reduction=True, save_device=save_device)

        self.in1_2 = AvgPool(out_channels, reduction=True, save_device=save_device)

        self.sel_0_1 = Ident(out_channels, reduction=False, save_device=save_device)

        self.sel_0_2_0 = Sep5(out_channels, reduction=False, save_device=save_device)
        self.sel_0_2_1 = Ident(out_channels, reduction=False, save_device=save_device)

        self.sel_0_3_0 = AvgPool(out_channels, reduction=False, save_device=save_device)
        self.sel_0_3_1 = MaxPool(out_channels, reduction=False, save_device=save_device)
    ...
    def forward(self, x_in0, x_in1):
        ...
        x_1 = F.dropout2d(self.in1_1(x_in1), training=self.training, p=self.drop_prob) + \
              F.dropout2d(self.sel_0_1(x_0), training=self.training, p=self.drop_prob)

        x_2 = F.dropout2d(self.in1_2(x_in1), training=self.training, p=self.drop_prob) + \
              F.dropout2d(self.sel_0_2_0(x_0), training=self.training, p=self.drop_prob) + \
              F.dropout2d(self.sel_0_2_1(x_0), training=self.training, p=self.drop_prob)

        x_3 = F.dropout2d(self.sel_0_3_0(x_0), training=self.training, p=self.drop_prob) + \
              F.dropout2d(self.sel_0_3_1(x_0), training=self.training, p=self.drop_prob)
